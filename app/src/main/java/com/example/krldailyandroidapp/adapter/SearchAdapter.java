...
public class SearchAdapter extends RecyclerView.Adapter<SearchAdapter.ArticleViewHolder>{
    ...
    public SearchAdapter(List<Article> articleList) {
    ...
    @NonNull
    @Override
    public SearchAdapter.ArticleViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        View view = LayoutInflater.from(parent.getContext()).inflate(R.layout.card_article, parent, false);
        return new ArticleViewHolder(view);
    }

    @Override
    public void onBindViewHolder(@NonNull SearchAdapter.ArticleViewHolder holder, int position) {
